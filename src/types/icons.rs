...
pub static ref MOVE :Image<'static> = Image::new(egui::include_image!("../assets/icons/light/move.png"));
pub static ref PENCIL :Image<'static> = Image::new(egui::include_image!("../assets/icons/light/pencil.png"));
pub static ref PIXELATE :Image<'static> = Image::new(egui::include_image!("../assets/icons/light/pixelate.png"));
...
pub static ref SELECT :Image<'static> = Image::new(egui::include_image!("../assets/icons/light/select.png"));
...
pub static ref WIDTH :Image<'static> = Image::new(egui::include_image!("../assets/icons/light/width.png"));
...
pub static ref MOVE_DARK :Image<'static> = Image::new(egui::include_image!("../assets/icons/dark/move_dark.png"));
pub static ref PENCIL_DARK :Image<'static> = Image::new(egui::include_image!("../assets/icons/dark/pencil_dark.png"));
pub static ref PIXELATE_DARK :Image<'static> = Image::new(egui::include_image!("../assets/icons/dark/pixelate_dark.png"));
...
pub static ref SELECT_DARK :Image<'static> = Image::new(egui::include_image!("../assets/icons/dark/select_dark.png"));
...
pub static ref WIDTH_DARK :Image<'static> = Image::new(egui::include_image!("../assets/icons/dark/width_dark.png"));
